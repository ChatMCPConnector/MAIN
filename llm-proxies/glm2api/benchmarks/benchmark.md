...
kein Benchmark fuer die Geschwindigkeit eines einzelnen API-Requests.
...
- Kein Netzwerkzugriff, keine externen Runtime-Abhaengigkeiten und keine
  generierten Binardateien. Python-Standardbibliothek plus `pytest` fuer Tests
  genuegt.
...
4. Antworte erst dann mit einem knappen Abschlussbericht: Test-Ergebnis,
   Output-Pfade und wichtigste Metriken. Keine Quellcode-Dumps und keine
